                    ...
                    <div>
                        <div className="flex items-center space-x-1.5 sm:space-x-2">
                            <a target="_blank" rel="noopener noreferrer" className="hover:text-[#e4e4e7] transition-colors duration-200">
                                <h3 className="text-[#fafafa] text-[15px] sm:text-md">Debut Infotech Pvt. Ltd.</h3>
                            </a>
            ...
            <div className="ml-6 sm:ml-8">
                <div className="flex items-start space-x-1.5 sm:space-x-2">
                    <div className="relative inline-flex h-2 w-2 mt-[6px] sm:mt-[6px] flex-shrink-0">
                        <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-[#71717a] opacity-75"></span>
