...
const Footer = () => {
    return(
        <div className="mb-5 description mt-1">
            ...
            <p className="description text-[13px] text-gray-600 ">That's it, thanks for visiting. Hope you like it.</p>
            <p className="mb-4 description text-[13px] text-gray-600">Built with Love by Lovepreet []~(￣▽￣)~*</p>
        </div>
    )
}
