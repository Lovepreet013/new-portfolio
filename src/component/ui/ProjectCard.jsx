...
const ProjectCard = ({ src, name, link, description }) => {
  return (
    <a
      ...
      className="block"
    >
      <div className="flex flex-col md:flex-row my-4 group border rounded-md border-gray-800 hover:border-gray-700 overflow-hidden w-full cursor-pointer hover:bg-[#131212]">
