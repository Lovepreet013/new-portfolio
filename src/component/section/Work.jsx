...
const Work = () => {
    return (
        <div className="mt-4 border-b-1 border-gray-800 text-gray-400 pb-6">
            <div className="flex items-center space-x-4">
                <h1 className="text-2xl text-gray-200 font-normal">Work</h1>
                ...
                <div className="flex items-start justify-between">
                    <div className="flex items-center space-x-2 sm:space-x-3">
                        ...
                        <div>
                            ...
                            <p className="text-[#a1a1aa] text-xs sm:text-sm mt-0.5">Software Engineer (Frontend)</p>
                        </div>
                    </div>
                ...
                <div className="flex items-start justify-between">
                    <div className="flex items-center space-x-2 sm:space-x-3">
                        ...
                        <div>
                            <div className="flex items-center space-x-1.5 sm:space-x-2">
                                <a target="_blank" rel="noopener noreferrer" className="hover:text-[#e4e4e7] transition-colors duration-200">
                                    <h3 className="text-[#fafafa] text-[15px] sm:text-md">Pixel Craft</h3>
                                </a>
                                <span className="px-1.5 py-0.5 bg-[#27272a] text-[#a1a1aa] text-[9px] sm:text-[10px] rounded-full">Internship</span>
                            </div>
